...
const struct multiboot_header header = {
    ...
    .info = {TAG(struct multiboot_info_request, MB2_TYPE_INFO_REQ, 0),
             .types = {M2IS_TYPE_CMDLINE, M2IS_TYPE_MODULE, M2IS_TYPE_MEMINFO, M2IS_TYPE_MEMMAP, M2IS_TYPE_FRAMEBUFFER},
    },
    .end = END_TAG,
};
